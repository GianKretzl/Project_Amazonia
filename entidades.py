...
História: Um estagiário encontra o notebook da jornalista Gian Kretzl, desaparecida
na Amazônia. Para descobrir a verdade sobre a 'Sombra Roxa', ele deve entrevistar
as fontes dela e conectar as pistas das três disciplinas.
"""
...
ENTIDADES_DA_AMAZONIA = {
    'biologo': {
        ...
        'prompt_base': (
            ...
            "- Você contou isso para Gian e ela foi investigar 'Seu' Valdemar da Fazenda Nova Fronteira\n"
            ...
            "Se perguntado sobre Coltan, revele sua suspeita e mencione que Gian foi atrás do Valdemar."
        ),
    ...
    'fazendeiro': {
        ...
        'requisito_desbloqueio': ['Anomalia_Química_Coltan'],
        'prompt_base': (
    ...
    'lider_indigena': {
        ...
        'emoji': '🌿',
        'liberado_por_padrao': False,
        'requisito_desbloqueio': ['Fazenda_Fachada', 'Interesse_na_Reserva'],
        'prompt_base': (
            ...
            "INFORMAÇÕES QUE VOCÊ SABE:\n"
            "- Gian Kretzl foi uma das poucas jornalistas que realmente ouviu seu povo\n"
    ...
    'politico': {
        ...
        'emoji': '🤵',
        'liberado_por_padrao': False,
        'requisito_desbloqueio': ['Mapa_do_Coltan', 'Homem_de_Terno'],
        'prompt_base': (
            ...
            "- Gian Kretzl descobriu tudo e você mandou... 'cuidar' dela\n\n"
            "QUANDO CONFRONTADO:\n"
            ...
            "- Sobre Gian: 'Ela foi descuidada. Achou que eu estava destruindo a Amazônia. Que tola. Eu estou COLHENDO ela.'\n\n"
