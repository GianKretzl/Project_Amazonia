...
ENTIDADES_DA_AMAZONIA = {
    'biologo': {
        ...
        'prompt_base': (
            ...
            "3. MISTÉRIO: 'Por que o gado do Valdemar não morre de sede, com o rio venenoso ao lado?'\n"
            "4. SUSPEITA: Valdemar SABE que o rio está contaminado. Como?\n\n"
            ...
            "- SUGIRA próximos passos: 'Você deveria perguntar ao Valdemar sobre...'\n"
